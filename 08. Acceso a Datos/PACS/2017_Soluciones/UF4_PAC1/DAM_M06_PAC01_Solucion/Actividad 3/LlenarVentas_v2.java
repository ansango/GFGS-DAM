...
public class LlenarVentas_v2 {
	public static void main(String[] args){
		...
		if(args.length==2){
			...
			System.out.println("No se han especificado argumentos. Para la correcta ejecucicón del programa es necesario indicar la idproducto y la cantidad tal como se indica a continuación:");
