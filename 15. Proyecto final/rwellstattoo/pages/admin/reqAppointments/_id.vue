...
<script>
import { getReqAppointmentById } from '../../../controllers/reqAppointments'
import { APPOINTMENTS_PATH, CREATE_APPOINTMENT, REQAPPOINTMENTS_PATH, DELETE_REQAPPOINTMENT } from '../../../store/types'
...
export default {
  ...
  methods: {
    ...
    createAppointment() {
      ...
      this.$store.dispatch(REQAPPOINTMENTS_PATH + DELETE_REQAPPOINTMENT, this.reqAppointment._id)
        .then((response) => {
